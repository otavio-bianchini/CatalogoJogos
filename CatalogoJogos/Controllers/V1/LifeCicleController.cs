...
namespace CatalogoJogos.Controllers.V1
{
    ...
    [ApiController]
    public class LifeCicleController : ControllerBase
    {
        ...
        public LifeCicleController(IExemploSingleton exemploSingleton1, 
    ...
    public class ExemploCicloDeVida : IExemploScoped, IExemploSingleton, IExemploTransient
    {
